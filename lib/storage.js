// Storage abstraction: uses Vercel KV when KV_REST_API_URL is set, falls back to in-memory Maps.
// To enable persistence: Vercel Dashboard → Storage → Create KV Store → attach to hollywood-agent project → redeploy.
...
} catch (e) { /* @vercel/kv not installed or KV not configured */ }
